...
# 安装sqlalchemy:
# 打开终端，输入pip install sqlalchemy -i http://pypi.douban.com/simple --trusted-host pypi.douban.com
...
#创建数据库的连接
engine = create_engine("mysql+pymysql://root:yl13795950539@127.0.0.1:3306/lagou?charset=utf8")
